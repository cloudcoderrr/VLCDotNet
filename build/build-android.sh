...
(
  cd "${CONTRIB_BUILD}"
  env "${CONTRIB_ENV[@]}" ../bootstrap --host="${TRIPLET}" --disable-disc --disable-x264 --disable-x265 --disable-mpg123 --disable-protobuf --disable-xcb --disable-goom --disable-sidplay2 --disable-vpx
